    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        post(id
          ...
          : '/api/admin/friend-links', Object.assign({}, values, {
        ...
        <Row>
          <Col md={{
            ...
            <Form onSubmit={this.handleSubmit}>
              ...
              <FormItem {...formItemLayout} label={< FormattedMessage id = "nut.attributes.friend-link.home" />} hasFeedback>
              ...
              <FormItem {...formItemLayout} label={< FormattedMessage id = "nut.attributes.friend-link.logo" />} hasFeedback>
